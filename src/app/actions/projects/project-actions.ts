...
export async function getAllProjectsAction(): Promise<ServerActionResponse> {
  try {
    ...
    logger.info('Retrieved all projects', { count: projects.length, userId: session.user.id })
 ...
 */
export async function getProjectByIdAction(projectId: string): Promise<ServerActionResponse> {
  try {
    const session = await requireAuth()
    ...
    logger.info('Retrieved project details', { projectId, userId: session.user.id })
 ...
 */
export async function createProjectAction(input: CreateProjectInput): Promise<ServerActionResponse> {
  try {
    const session = await requireAuth()
 ...
 */
export async function updateProjectAction(input: UpdateProjectInput): Promise<ServerActionResponse> {
  try {
    const session = await requireAuth()
 ...
 * Delete a project
 */
export async function deleteProjectAction(projectId: string): Promise<ServerActionResponse> {
  try {
    const session = await requireAuth()
 ...
 */
export async function testProjectConnectionAction(databaseUrl: string): Promise<ServerActionResponse> {
  try {
    const session = await requireAuth()
    ...
    const result = await errorHandler(async () => {
      ...
      try {
        ...
        logger.info('Database connection test successful', { userId: session.user.id })

        return { success: true, message: 'Connection successful' }
      } catch (error) {
        await sql.end()
        throw new ValidationError('Failed to connect to database: ' + (error instanceof Error ? error.message : 'Unknown error'))
      }
